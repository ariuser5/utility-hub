...
**Usage:**
```powershell
.\src\scripts\gdrive\Archive-GDriveFolder.ps1 -FolderPath "MyFolder/Documents"
.\src\scripts\gdrive\Archive-GDriveFolder.ps1 -FolderPath "Reports" -FilePattern "*.pdf" -OutputPath ".\backup.zip"
```
...
**Usage:**
```powershell
.\src\scripts\gdrive\Upload-ToGDrive.ps1 -DestinationPath "Backups" -LocalFilePath ".\archive.zip"
.\src\scripts\gdrive\Upload-ToGDrive.ps1 -DestinationPath "Backups" -LocalFilePath ".\archive.zip" -Overwrite
.\src\scripts\gdrive\Upload-ToGDrive.ps1 -DestinationPath "Backups" -LocalFilePath ".\archive.zip" -NoCreate
```
